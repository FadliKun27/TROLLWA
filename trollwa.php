?php
echo "COPYRIGHT : FadliKun\n\n";
echo "Nomor Targetnya apa lurr?\nInput : ";
...
User-Agent: Mozilla/5.0 (Linux; Android 7.1.2; Redmi 4X Build/N2G47H) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68
...
Cookie: identity=".$rand1."; browser_id=".$rand2."; _ga=GA1.2.1024758930.1531960985; _vwo_uuid_v2=DE8E70E7E9A8960F05F2
<------>global $config;
